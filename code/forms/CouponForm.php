...
class CouponForm extends OrderModifierForm{
	...
	public function __construct($controller = null, $name = "CouponForm") {
	 ...
	 * @return string
	 */
	public function apply($data, $form) {
	...
	public function php($data) {
		...
		if(!$order || !$order->Items()){
			$this->validationError('Code',
				_t("OrderCouponModifier.NOORDERSTARTED", "No order found. You must start an order before using a coupon."),
				"bad"
			);
			return false;
		}
